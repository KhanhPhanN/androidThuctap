...
// Package
package com.example.enterc.practiceinter.furiganaview;
...
public class FuriganaView extends View {
    ...
    private int textFuriganaColor = getResources().getColor(R.color.colorgreen);
    private int textNormalColor = getResources().getColor(R.color.colorgreen);
    private int lineFuriganaColor;
    ...
    private class TextFurigana {
        ...
        public TextFurigana(String text) {
            //Color (added by Duy)
            m_paint_f.setColor(textFuriganaColor);
    ...
    private class TextNormal {
        ...
        public TextNormal(String text, boolean is_marked) {
            ...
            //Color (added by Duy)
            m_paint_k_mark.setColor(textNormalColor);
            m_paint_k_norm.setColor(textNormalColor);
    ...
    private class LineFurigana {
        ...
        public void calculate() {
            ...
            */
            ...
            // r[] - ideal offsets
            float[] r = new float[size_text];
            for (int i = 0; i < size_text; i++)
                r[i] = m_text.get(i).offset_get();

            // a[] - constraint matrix
            float[][] a = new float[size_text + 1][size_text];
    ...
    public void text_set(TextPaint tp, String text, int mark_s, int mark_e) {
        ...
        m_paint_f.setTextSize(m_paint_f.getTextSize() / 2f);
    ...
    public int getTextFuriganaColor() {
        return textFuriganaColor;
    }

    public void setTextFuriganaColor(int textFuriganaColor) {
        this.textFuriganaColor = textFuriganaColor;
    }
