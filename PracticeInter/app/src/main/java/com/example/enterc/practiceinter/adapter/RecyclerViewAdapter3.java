...
public class RecyclerViewAdapter3 extends RecyclerView.Adapter<RecyclerViewAdapter3.RecyclerViewHolder3>{
    ArrayList<NewestJpopJSONOject.Song> songs;
    Context context;

    public RecyclerViewAdapter3(ArrayList<NewestJpopJSONOject.Song> songs, Context context) {
        this.songs = songs;
    ...
    @NonNull
    @Override
    public RecyclerViewHolder3 onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull RecyclerViewHolder3 r, final int i) {
